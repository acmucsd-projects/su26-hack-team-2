...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative flex flex-col gap-8 px-6 py-24 sm:px-12 sm:py-32 max-w-3xl">
        <div>
          <p className="text-xl font-medium text-navy tracking-wide">THE</p>
          <h1 className="text-6xl sm:text-7xl font-extrabold text-navy leading-none">TRITON</h1>
          <p className="text-5xl sm:text-6xl text-navy leading-none mt-1">CLUBHOUSE</p>
        </div>
