  ...
  return (
    <section className="bg-cream px-6 py-24 sm:px-12">
      <div className="max-w-5xl mx-auto flex flex-col gap-8">
        <h2 className="text-4xl sm:text-5xl font-extrabold text-navy leading-tight max-w-2xl">
          Everything your club needs to launch and run smoothly.
        </h2>

        <Badge variant="role" className="h-auto gap-2 bg-navy px-4 py-1.5 text-sm text-cream">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* {FEATURES.map((feature) => (
            <StatCard key={feature.title} {...feature} />
          ))} */}
        </div>
